pipeline {
    ...
    environment {
        ...
        //IMAGE_NAME = "wimetrixcregistery/Nishat-backend-packing"
    ...
    stages {
        ...
        steps {
            ...
            checkout([$class: 'GitSCM',
                    ...
                    extensions: [
                        [$class: 'WipeWorkspace'],
                        [$class: 'RelativeTargetDirectory', relativeTargetDir: '/home/jenkins/deployment-package/wimetrix/Nishat-backend-packing']
                    ],
                    submoduleCfg: [],
                    userRemoteConfigs: [[
                        credentialsId: 'GithubCredentials',
                        url: 'https://github.com/WiMetrixDev/dep-Nishat-backend-packing.git'
                    ]]
            ])
            ...
            checkout([$class: 'GitSCM',
                    ...
                    extensions: [
                        [$class: 'WipeWorkspace'],
                        [$class: 'RelativeTargetDirectory', relativeTargetDir: '/home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source']
                    ],
                    submoduleCfg: [],
                    userRemoteConfigs: [[
                        credentialsId: 'GithubCredentials',
    ...
    steps {
        script {
            ...
            withCredentials([
                    ...
                    sh label: '', script: '''
                        cp /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/Dockerfile /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source/
                        cp /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/.dockerignore /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source/
                        cd /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source/shared-env/backend
                        cp ${SECRET_FILE} /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source/shared-env/backend/.env.production
                '''
                dockerImage = docker.build("${REGISTRY_URL}/${IMAGE_NAME}:${env.BUILD_ID}",
                    "-f ${sourceDir}/Dockerfile ${sourceDir}")

                sh label: '', script: '''
                rm -rf /home/jenkins/deployment-package/wimetrix/Nishat-backend-packing/source/*
                ''' 
                    }                 
            }
        }
